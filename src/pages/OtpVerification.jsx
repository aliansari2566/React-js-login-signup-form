...
export const OtpVerification = () =>{
    ...
    const navigateToLogin = () => {     
      ...
      function validateForm (){
        ...
        if(otp=="")
        {
          return setValidateOtp("Please Enter Your Otp")
        }
        ...
        if(otp != ""){
         ...
         {
          return  setValidateOtp("Enter valid Otp Number ")
         }
         else{
          setValidateOtp("")
         }
 ...
 return(
       ...
       <div className="login-paragraph">
        ...
        <h4 className="SignIn-Heading">Otp Verification</h4>
            ...
            <input  type="text" onChange={(e) => setOtp(e.target.value)} value={otp}  className="input " style={linkInputStyle} placeholder="Enter Your Otp" required/>
            <p className="validateStyle">{validateOtp}</p>
